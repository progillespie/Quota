...
dir.create(outdata , showWarnings=F, recursive = T)
dir.create(outgraph, showWarnings=F, recursive = T)
dir.create(origdata, showWarnings=F, recursive = T)
